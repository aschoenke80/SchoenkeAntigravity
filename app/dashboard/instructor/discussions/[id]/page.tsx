...
export default async function InstructorDiscussionDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div>
      <Link href="/dashboard/instructor/discussions"
      ...
      <DiscussionThreadClient
        ...
        backHref="/dashboard/instructor/discussions"
      />
    </div>
  )
}
